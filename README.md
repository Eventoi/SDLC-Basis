...
> [!NOTE]
> Нет, идея не является начальным этапом SDLC. Идей можно предложить сколько угодно, но не все начнут свой жизненный цикл в виде решения о необходимости создания программного продукта
