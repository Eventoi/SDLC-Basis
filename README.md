> [!IMPORTANT]
> Шпаргалки, посвященные SDLC, цель которых: дать устойчивую *<ins>начальную</ins>* базу знаний по каждому этапу жизненного цикла ПО
...
> [!NOTE]
> Нет, идея не является начальным этапом SDLC. Идей можно предложить сколько угодно, но не все начнут свой *<ins>жизненный</ins>* цикл в виде решения о необходимости *<ins>создания</ins>* программного продукта

> Например, сажая зерна в землю вы не сможете точно определить какие из них взойдут. Это можно сделать только увидев ростки