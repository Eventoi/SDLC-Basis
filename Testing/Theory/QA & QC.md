...
> [!NOTE]
> Это включает в себя и обучение персонала, и подбор инструментов, и формат написания документации, и сбор информации о ПО, и улучшение процесса разработки путем внедрения лучших практик и отказа от нерабочих методик в работе всех участников процесса (разработчиков, аналитиков, дизайнеров, тестировщиков, техподдержки), и коммуникационные активности и многое другое

### Полный стек технологий (Fullstack QA)
Специалист, сочетающий в себе ЗУН QA и автоматизатора тестирования (знание основных принципов программирования, фреймворк, формирование отчетности)

> [!NOTE]
> Помимо указанного, также необходимы владение БД и умение настройки и конфигурации CI/CD (DevOps)