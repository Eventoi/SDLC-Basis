...
> [!TIP]
> Набор тестов, тестовых данных и подходов нужно постоянно пересматривать и улучшать для выявления не найденных ошибок. Для этого необходимо:
> 1. обновлять тесты и тестовые данные после исправления найденных дефектов
> 2. назначать разных тестировщиков на доработки одного модуля или при регрессе, для поддержки актуальности и привнесения в документацию новых идей
